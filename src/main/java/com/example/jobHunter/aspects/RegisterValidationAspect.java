package com.example.jobHunter.aspects;


import com.example.jobHunter.Entity.JobPortalUser;
import com.example.jobHunter.dto.RegisterRequestDto;
import com.example.jobHunter.exception.RegistrationValidationException;
...
public class RegisterValidationAspect {
    ...
    @Before("""
        execution(* com.example.jobHunter.auth.AuthController
        .registerUser(..))
        """)
